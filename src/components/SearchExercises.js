...
const SearchExercises = ({setExercises,bodyPart,setBodyPart}) => {
  ...
  useEffect(() => {
    ...
    fetchExercisesData();
  }, [])  // i want to call it at the start that is why the dependency array is empty 
  ...
  return (
    <Stack alignItems="center" justifyContent="center" mt="37px" p="20px">
      <Typography fontWeight={700} sx={{ fontSize: { lg: "44px", xs: "30px" } }} mb="50px" textAlign="center">
        Unlock your fitness potential <br /> with these incredible exercises
      </Typography>
      <Box position="relative" mb="72px">
        ...
        <Button className='search-btn' sx={{
          bgcolor: '#ff2625', color: '#fff', textTransform: 'none', width: { lg: '175px', xs: '80px' }, fontSize: { lg: '20px', xs: '14px' }, height: '56px', position: 'absolute', borderRadius: '8px', right: '0'
